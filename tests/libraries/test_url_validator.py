...
class TestUrlValidator(object):
    ...
    def test_with_path(self):
        ...
        assert result == ['abc.com/xyz',
                          'https://abc.com/xyz', 'http://abc.com/xyz']

        result = UrlValidator('www.abc.com/xyz', '').get_allowed_urls()
        assert result == ['www.abc.com/xyz',
                          'https://www.abc.com/xyz', 'http://www.abc.com/xyz']

    def test_normalize_url(self):
        assert 'abc.com' == UrlValidator('', '').normalize_url('abc.com//')
        assert 'abc.com' == UrlValidator('', '').normalize_url('ABC.com//')
        assert 'abc.com/xyz' == UrlValidator('',
                                             '').normalize_url('ABC.com/xyz/')
        assert 'https://www.abc.com' == UrlValidator(
            '', '').normalize_url('https://www.ABC.com//')
